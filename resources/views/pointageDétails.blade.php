         ...
         <div class="container contact">	
          <div >   		
            ...
            <div class="card-header">
                <h5 class="card-title text-center">Détails du pointage</h5>
            </div>
            <div class="card-body">
                <div class="row">
...
@endif                        <div>
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><strong>heure entree :</strong> <span id="details-heureentree">{{ $heureentree }}</span></p>
                                <p><strong>heure sortie:</strong> <span id="details-heuresortie">{{ $heuresortie }}</span></p>
                                <p><strong>date jour :</strong> <span id="details-date-jour">{{ $jour }}</span></p>
